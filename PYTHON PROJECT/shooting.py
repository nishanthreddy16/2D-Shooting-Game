...
# Bullet cooldown management
bullet_ready = True
bullet_cooldown = 300  # milliseconds for bullet cooldown
...
while running:
    if not game_active:
        ...
        if paused:
            ...
            # Shoot a bullet only once when space is pressed
